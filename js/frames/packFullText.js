...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	loadTextOptions({
		...
		title: {name:'Title', text:'', x:0.0854, y:0.0522, width:0.8292, height:0.0543, oneLine:true, font:'matrix', size:0.0381},
		type: {name:'Type', text:'', x:0.0854, y:0.1148, width:0.8292, height:0.0543, oneLine:true, font:'matrix', size:0.0324},
		rules: {name:'Rules Text', text:'', x:0.086, y:0.1791, width:0.828, height:0.7391, size:0.0362, font:'matrix'},
